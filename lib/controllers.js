...
Controllers.paymentSetup = function (req, res, next) {
    payment.paymentSetupRoute(req,res,next);
}

Controllers.paymentExecution = function (req, res, next) {
    payment.paymentExecutionRoute(req,res,next);
}

Controllers.paymentValidation = function (req, res, next) {
    payment.paymentValidationRoute(req,res,next);
}
