...
var Subscriptions = {};
    ...
    Subscriptions.getUserSubscription = function(uid,subscriptionname){
    ...
    Subscriptions.isInPaidForPeriod = function(usersubscription){
    ...
    Subscriptions.onExpired = function(usersubscription,callback){
